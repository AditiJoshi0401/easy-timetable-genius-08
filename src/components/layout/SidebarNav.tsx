...
export function SidebarNav({
  ...
  return <div id="sidebar" className="h-screen w-64 border-r border-border/40 bg-sidebar shadow-subtle flex flex-col animate-slide-in">
      <div className="p-6">
      ...
      <nav className="flex-1 px-3 py-4">
        <div className="space-y-1">
          ...
          isActive
        }) => cn("flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200", "hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground", isActive ? "bg-sidebar-accent text-sidebar-accent-foreground" : "text-sidebar-foreground/80")} end={item.to === "/"} onClick={onClose}>
